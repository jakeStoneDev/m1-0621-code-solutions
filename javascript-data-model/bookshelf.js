...
console.log('index at [1].author value: ', bookshelf[1].author);
console.log('index at [0].isbn value: ', bookshelf[0].isbn);
console.log('index at [2].title value: ', bookshelf[2].title);
